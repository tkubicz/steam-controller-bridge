...
Either trackpad may independently drive a relative pointer or smooth two-axis
scrolling, and either may be divided into regions whose clicks and touches fire
their own desktop actions. These host-side paths do not change `GamepadState`,
serial frames, or firmware behavior. See
[Desktop bindings](DESKTOP_BINDINGS.md).
...
gameplay default. In that diagnostic profile a desktop right-pad region binding
