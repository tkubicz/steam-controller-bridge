...
pub use model::{
    ...
    PadFeedbackRequest, PadFeedbackStrength, PadMotionMode, PadRegion, PadRegionPreset,
    PadRegionShape, PadSample, PadSide, PadTrigger, BINDINGS_VERSION, DEFAULT_CENTER_PERCENT,
    DEFAULT_PAD_SPEED_PERCENT, DEFAULT_PROFILE_ID, DEFAULT_PROFILE_NAME, MAX_PAD_REGIONS,
    MAX_PAD_SPEED_PERCENT, MAX_PROFILES, MAX_PROFILE_NAME_CHARS, MAX_REGION_NAME_CHARS,
    MIN_PAD_SPEED_PERCENT,
};
#[cfg(target_os = "macos")]
pub use platform::{
