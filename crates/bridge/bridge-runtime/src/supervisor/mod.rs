use super::{
    automatic_shutdown_phase, available_serial_endpoints, bounded_error, choose_unique_active,
    controller_inventory_scan_interval, controller_open_error, controller_open_error_message,
    desktop_transition_mask, discover_bridge_endpoints, io, json, masked_serial, mpsc,
    ...
    AutomaticShutdownPhase, AutomaticShutdownRuntime, BridgeEndpoint, BridgeEndpointDiscovery,
    BridgeEndpointSelection, BridgeEngine, BridgeOutput, BridgeStatus, BridgeTransportError,
    CommandAck, ConnectionState, ControllerChargeState, ControllerCooldown,
    ControllerDiscoveryState, ControllerEnumerator, ControllerOpenFailure, ControllerSelection,
    ControllerSourceStatus, ControllerStatus, ControllerTransport, DecodedReport,
    DesktopBindingsWorker, DesktopInputSnapshot, DeviceError, DeviceEvent, DumpOutput, Duration,
    File, FileOutput, FirmwareInstallReceipt, GamepadOutput, HapticsState, HapticsStatus,
    ...
    OutputError, OutputFeedback, OutputFeedbackSemantics, OutputRetryState, OutputSelection,
    ...
    KIND_DEVICE_DISCONNECTED, MIN_STABLE_CONTROLLER_SCAN_INTERVAL, PAD_FEEDBACK_RETRY_INTERVAL,
    POWER_OFF_BURST_INTERVAL, POWER_OFF_BURST_WRITES, POWER_OFF_COOLDOWN, RUMBLE_LEASE_TIMEOUT,
    RUMBLE_REFRESH_INTERVAL, RUMBLE_RETRY_INTERVAL, RUNTIME_POLL_INTERVAL, STATUS_INTERVAL,
    WAKE_SETTLE_DELAY,
};
...
pub(crate) struct Supervisor {
    ...
    output_discovery_warnings: Vec<String>,
    preferred_output_stable_id: Option<String>,
...
impl Supervisor {
    pub(crate) fn new(
        ...
        Self {
            ...
            output_discovery_warnings: Vec::new(),
            preferred_output_stable_id: None,
